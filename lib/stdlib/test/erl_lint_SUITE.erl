...
">>,
	   ...
	   {warnings,[{{1,3},erl_lint,{unused_var,'F'}},
             {{15,12},erl_lint,{unused_var,'Y'}},
             {{22,3},erl_lint,{unused_var,'N'}},
             {{23,19},erl_lint,{shadowed_var,'N','fun'}},
             {{28,14},erl_lint,{unused_var,'B'}},
             {{29,14},erl_lint,{unused_var,'B'}}]}}],
    ?line [] = run(Config, Ts),
    ok.
...
">>,
           [warn_unused_vars],
           {warnings, [{{4,13},erl_lint,{shadowed_var,'X',generate}},
                       {{7,8},erl_lint,{unused_var,'Y'}}]}},
...
">>,
           [warn_unused_vars],
           {warnings,[{{2,5},erl_lint,{unused_var,'B'}}]}},
...
">>,
           [warn_unused_vars],
           {warnings,[{{3,16},erl_lint,{unused_var,'Id'}}]}},
...
">>,
           [warn_unused_vars],
           {warnings,[{{2,5},erl_lint,{unused_var,'B'}},
                      {{3,11},erl_lint,{shadowed_var,'B',generate}}]}},
...
">>,
           [warn_unused_vars],
           {warnings,[{{3,11},erl_lint,{shadowed_var,'B',generate}}]}},
...
">>,
           [warn_unused_vars],
           {warnings,[{{3,11},erl_lint,{unused_var,'B'}},
                      {{3,11},erl_lint,{shadowed_var,'B',generate}}]}},
...
">>,
           [warn_unused_vars],
           {warnings,[{{2,11},erl_lint,{unused_var,'Z'}},
                      {{3,15},erl_lint,{unused_var,'X'}},
                      {{3,15},erl_lint,{shadowed_var,'X',generate}},
                      {{3,11},erl_lint,{shadowed_var,'Z',generate}}]}},
...
">>,
           [warn_unused_vars],
           {warnings,[{{2,11},erl_lint,{unused_var,'Z'}},
                      {{3,11},erl_lint,{unused_var,'Z'}},
                      {{3,11},erl_lint,{shadowed_var,'Z',generate}},
                      {{4,11},erl_lint,{unused_var,'Z'}},
                      {{4,11},erl_lint,{shadowed_var,'Z',generate}},
                      {{5,11},erl_lint,{shadowed_var,'Z',generate}},
                      {{7,13},erl_lint,{shadowed_var,'X',generate}},
                      {{8,11},erl_lint,{unused_var,'X'}},
                      {{8,11},erl_lint,{shadowed_var,'X',generate}},
                      {{10,20},erl_lint,{unused_var,'Y'}},
                      {{11,11},erl_lint,{shadowed_var,'X',generate}},
                      {{12,11},erl_lint,{unused_var,'X'}},
                      {{12,11},erl_lint,{shadowed_var,'X',generate}}]}},
...
">>,
           [warn_unused_vars],
           {error,[{{8,7},erl_lint,{unbound_var,'Y'}},
                   {{11,10},erl_lint,{unbound_var,'Y'}}],
                  [{{2,16},erl_lint,{unused_var,'Y'}},
                   {{4,20},erl_lint,{unused_var,'Y'}},
                   {{8,20},erl_lint,{unused_var,'Y'}},
                   {{10,17},erl_lint,{unused_var,'Y'}},
                   {{13,22},erl_lint,{unused_var,'Z'}},
                   {{15,11},erl_lint,{unused_var,'Y'}}]}},
...
">>,
           [warn_unused_vars],
           {warnings,[{{3,11},erl_lint,{shadowed_var,'Z',generate}}]}},
...
">>,
           [warn_unused_vars],
           {warnings,[{{4,11},erl_lint,{unused_var,'Z'}},
                      {{4,11},erl_lint,{shadowed_var,'Z',generate}}]}},
...
">>,
           [warn_unused_vars],
           {error,[{{22,13},erl_lint,{unsafe_var,'U',{'case',{2,5}}}},
                   {{27,13},erl_lint,{unsafe_var,'U',{'case',{2,5}}}}],
            [{{16,13},erl_lint,{unused_var,'Y'}},
     %  {{24,23},erl_lint,{exported_var,'X',{'case',{8,5}}}},
             {{24,21},erl_lint,{unused_var,'U'}},
     %  {{26,23},erl_lint,{exported_var,'X',{'case',{8,5}}}},
             {{26,21},erl_lint,{unused_var,'U'}}]}},
...
">>,
           [warn_unused_vars],
           {error,[{{22,5},erl_lint,{unsafe_var,'U',{'case',{3,5}}}}],
            [{{17,13},erl_lint,{unused_var,'Y'}},
     %  {{21,15},erl_lint,{exported_var,'X',{'case',{9,5}}}},
             {{21,13},erl_lint,{unused_var,'U'}}]}},
...
">>,
           [warn_unused_vars],
           {error,[{{21,13},erl_lint,{unsafe_var,'U',{'case',{2,5}}}},
                   {{21,27},erl_lint,{unsafe_var,'Y',{'case',{14,5}}}}],
            [{{20,13},erl_lint,{unused_var,'U'}}
     %       ,{{21,20},erl_lint,{exported_var,'X',{'case',{8,5}}}}
     %       ,{{21,13},erl_lint,{shadowed_var,'U',generate}}
            ]}},
...
">>,
           [warn_unused_vars],
           {warnings,[{{4,7},erl_lint,{unused_var,'A'}}]}},
...
">>,
           [warn_unused_vars],
           {warnings,[{{6,4},erl_lint,{unused_var,'C1'}},
		      {7,sys_core_fold,no_clause_match},
                      {{9,11},erl_lint,{unused_var,'C3'}}]}},
...
">>,
           [warn_unused_vars],
           {error,[{{6,13},erl_lint,{unbound_var,'X'}}],
                  [{{14,11},erl_lint,{unused_var,'Q'}}]}}
...
">>,
           [warn_unused_vars],
           {warnings,[{{22,27},erl_lint,{unused_var,'Same'}}]}}],
    ?line [] = run(Config, Ts),
    ok.
...
">>,
           ...
           {warnings,[{{1,4},erl_lint,{unused_var,'A'}},
                  {{2,9},erl_lint,{unused_var,'A'}},
                  {{2,9},erl_lint,{shadowed_var,'A','fun'}},
                  {{4,11},erl_lint,{unused_var,'A'}},
                  {{4,11},erl_lint,{shadowed_var,'A','fun'}},
                  {{5,12},erl_lint,{unused_var,'Q'}},
                  {{8,9},erl_lint,{unused_var,'E'}},
                  {{8,9},erl_lint,{shadowed_var,'E','fun'}},
		  {8,sys_core_fold,useless_building},
                  {{12,12},erl_lint,{unused_var,'E'}}]}},
...
">>,
           [warn_unused_vars],
           {error,[{{9,5},erl_lint,{unsafe_var,'U',{'case',{2,5}}}}],
              [{{8,9},erl_lint,{unused_var,'U'}},
               {{17,9},erl_lint,{unused_var,'U'}},
               {{17,9},erl_lint,{shadowed_var,'U','fun'}},
               {{22,13},erl_lint,{unused_var,'U'}},
               {{24,13},erl_lint,{unused_var,'U'}},
               {{26,9},erl_lint,{unused_var,'U'}},
               {{26,9},erl_lint,{shadowed_var,'U','fun'}}]}}
          ],
    ?line [] = run(Config, Ts),
    ok.
...
">>,
           [warn_unused_vars],
           {error,[{{4,24},erl_lint,{unbound_var,'BadSize'}}],
              [{{4,22},erl_lint,{unused_var,'B'}},
               {{4,7},erl_lint,{unused_var,'Size'}},
               {{8,12},erl_lint,{unused_var,'B'}},
               {{8,26},erl_lint,{unused_var,'Rest'}}]}}
         ],
    ?line [] = run(Config, Ts),
    ok.
...
">>,
           [warn_unused_vars],
           {error,[{{14,13},erl_lint,{unsafe_var,'A',{'case',{2,5}}}}],
                  [{{6,13},erl_lint,{unused_var,'W'}},
                   {{7,13},erl_lint,{unused_var,'Z'}},
                   {{10,13},erl_lint,{unused_var,'Z'}},
                   {{15,13},erl_lint,{unused_var,'X'}},
                   {{19,13},erl_lint,{exported_var,'B',{'case',{2,5}}}},
                   {{20,13},erl_lint,{unused_var,'U'}},
                   {{25,13},erl_lint,{unused_var,'X'}},
                   {{26,13},erl_lint,{unused_var,'U'}}]}},
...
">>,
           [warn_export_vars],
           {error,[{{9,9},erl_lint,{unbound_var,'B'}}],
                  [{{8,15},erl_lint,{exported_var,'X',{'receive',{2,5}}}},
                   {{9,5},erl_lint,{exported_var,'Y',{'receive',{2,5}}}},
                   {{10,16},erl_lint,{exported_var,'Z',{'receive',{2,5}}}},
                   {{10,11},erl_lint,{shadowed_var,'B',generate}}]}},
...
">>,
	   ...
	   {warnings,[{{5,1},erl_lint,{unused_function,{fact,1}}},
		      {{8,1},erl_lint,{unused_function,{fact_1,2}}}]}},
...
">>,
           [warn_unused_vars],
           {error,[{{3,5},erl_lint,{unsafe_var,'Y',{'orelse',{2,16}}}}],
            [{{2,6},erl_lint,{unused_var,'X'}}]}},
          {unsafe2,
           <<"
t2() ->
    (X = true) orelse (Y = false),
...
">>,
           [warn_unused_vars],
           {warnings,[{{2,24},erl_lint,{unused_var,'Y'}}]}},
          {unsafe3,
           <<"
t3() ->
    ...
    Y.
           ">>,
           [warn_unused_vars],
           {error,[{{3,5},erl_lint,{unsafe_var,'Y',{'andalso',{2,16}}}}],
            [{{2,6},erl_lint,{unused_var,'X'}}]}},
          {unsafe4,
           <<"
t4() ->
...
">>,
           [warn_unused_vars],
           {errors,[{{3,18},erl_lint,{unsafe_var,'X',{'if',{2,6}}}},
                    {{4,5},erl_lint,{unsafe_var,'X',{'if',{2,6}}}}],
            []}}
         ],
    ?line [] = run(Config, Ts),
    ok.
...
">>,
           [warn_unused_vars],
           {errors,[{{9,5},erl_lint,{unsafe_var,'State1',{'if',{4,13}}}}],[]}},
          {unsafe2_2,
           <<"
foo(State) ->
    case State of
...
">>,
	   [],
	   {errors,[{{6,5},erl_lint,{unsafe_var,'Result',{'try',{2,5}}}},
		    {{13,5},erl_lint,{unsafe_var,'Result',{'try',{8,5}}}},
		    {{20,5},erl_lint,{unsafe_var,'Result',{'try',{15,5}}}}],
	    []}},
	  {unsafe_try2,
	   <<"
foo1a() ->
...
">>,
	   [],
	   {errors,[{{9,13},erl_lint,{unsafe_var,'Ra',{'try',{3,9}}}},
                    {{9,10},erl_lint,{unsafe_var,'Rc',{'try',{3,9}}}},
		    {{17,16},erl_lint,{unsafe_var,'R',{'try',{12,9}}}},
		    {{19,13},erl_lint,{unsafe_var,'Ra',{'try',{12,9}}}},
		    {{19,10},erl_lint,{unsafe_var,'Rc',{'try',{12,9}}}},
		    {{27,16},erl_lint,{unsafe_var,'R',{'try',{22,9}}}},
		    {{29,13},erl_lint,{unsafe_var,'Ra',{'try',{22,9}}}},
		    {{29,10},erl_lint,{unsafe_var,'Ro',{'try',{22,9}}}},
		    {{37,16},erl_lint,{unsafe_var,'R',{'try',{32,9}}}},
		    {{39,10},erl_lint,{unsafe_var,'R',{'try',{32,9}}}},
		    {{39,18},erl_lint,{unsafe_var,'Ra',{'try',{32,9}}}},
                    {{39,15},erl_lint,{unsafe_var,'Rc',{'try',{32,9}}}},
                    {{39,12},erl_lint,{unsafe_var,'Ro',{'try',{32,9}}}}],
	    []}},
	  {unsafe_try3,
	   <<"
foo1(X) ->
...
">>,
	   [],
	   {errors,[{{5,33},erl_lint,{unsafe_var,'R',{'try',{3,9}}}},
		    {{7,12},erl_lint,{unsafe_var,'Rc',{'try',{3,9}}}},
		    {{11,25},erl_lint,{unsafe_var,'R',{'try',{10,9}}}},
		    {{13,32},erl_lint,{unbound_var,'RR'}},
		    {{13,35},erl_lint,{unbound_var,'Ro'}},
		    {{13,30},erl_lint,{unsafe_var,'R',{'try',{10,9}}}},
		    {{15,20},erl_lint,{unsafe_var,'Class',{'try',{10,9}}}},
		    {{15,26},erl_lint,{unsafe_var,'Data',{'try',{10,9}}}},
		    {{15,12},erl_lint,{unsafe_var,'R',{'try',{10,9}}}},
		    {{15,14},erl_lint,{unsafe_var,'RR',{'try',{10,9}}}},
		    {{15,17},erl_lint,{unsafe_var,'Ro',{'try',{10,9}}}},
		    {{19,22},erl_lint,{unsafe_var,'R',{'try',{18,9}}}},
		    {{21,32},erl_lint,{unbound_var,'RR'}},
		    {{21,30},erl_lint,{unsafe_var,'R',{'try',{18,9}}}},
		    {{23,24},erl_lint,{unsafe_var,'Class',{'try',{18,9}}}},
		    {{23,30},erl_lint,{unsafe_var,'Data',{'try',{18,9}}}},
		    {{23,19},erl_lint,{unsafe_var,'R',{'try',{18,9}}}},
		    {{23,21},erl_lint,{unsafe_var,'RR',{'try',{18,9}}}},
		    {{25,20},erl_lint,{unsafe_var,'Class',{'try',{18,9}}}},
                    {{25,26},erl_lint,{unsafe_var,'Data',{'try',{18,9}}}},
		    {{25,12},erl_lint,{unsafe_var,'R',{'try',{18,9}}}},
		    {{25,14},erl_lint,{unsafe_var,'RR',{'try',{18,9}}}},
		    {{25,17},erl_lint,{unsafe_var,'Ra',{'try',{18,9}}}}],
	    []}},
	  {unsafe_try4,
	   <<"
foo1(X) ->
...
">>,
	   [],
	   {errors,[{{4,25},erl_lint,{unsafe_var,'R',{'try',{3,9}}}},
		    {{6,35},erl_lint,{unbound_var,'RR'}},
		    {{6,38},erl_lint,{unbound_var,'Ro'}},
		    {{6,33},erl_lint,{unsafe_var,'R',{'try',{3,9}}}},
		    {{8,30},erl_lint,{unsafe_var,'Class',{'try',{3,9}}}},
		    {{8,36},erl_lint,{unsafe_var,'Data',{'try',{3,9}}}},
		    {{8,19},erl_lint,{unsafe_var,'R',{'try',{3,9}}}},
		    {{8,21},erl_lint,{unsafe_var,'RR',{'try',{3,9}}}},
		    {{8,27},erl_lint,{unsafe_var,'Rc',{'try',{3,9}}}},
		    {{8,24},erl_lint,{unsafe_var,'Ro',{'try',{3,9}}}},
		    {{10,26},erl_lint,{unsafe_var,'Class',{'try',{3,9}}}},
                    {{10,32},erl_lint,{unsafe_var,'Data',{'try',{3,9}}}},
		    {{10,12},erl_lint,{unsafe_var,'R',{'try',{3,9}}}},
		    {{10,14},erl_lint,{unsafe_var,'RR',{'try',{3,9}}}},
		    {{10,23},erl_lint,{unsafe_var,'Ra',{'try',{3,9}}}},
		    {{10,20},erl_lint,{unsafe_var,'Rc',{'try',{3,9}}}},
		    {{10,17},erl_lint,{unsafe_var,'Ro',{'try',{3,9}}}}],
	    []}}],
        ?line [] = run(Config, Ts),
    ok.
...
">>,
           ...
           {error,
	    [{{6,11},erl_lint,illegal_guard_expr},
             {{18,11},erl_lint,illegal_guard_expr}],
	    [{{18,11},erl_lint,{removed,{erlang,is_constant,1},
			   "Removed in R13B"}}]}},
          {guard2,
           <<"
-record(apa,{}).
...
">>,
           [nowarn_obsolete_guard],
	   {error,[{{6,12},erl_lint,illegal_guard_expr},
		   {{6,25},erl_lint,illegal_guard_expr},
		   {{18,12},erl_lint,illegal_guard_expr},
		   {{18,28},erl_lint,illegal_guard_expr}],
	    [{{18,12},erl_lint,{removed,{erlang,is_constant,1},
			   "Removed in R13B"}},
             {{18,28},erl_lint,{removed,{erlang,is_constant,1},
			   "Removed in R13B"}}]}},
          {guard3,
           <<"
-record(apa,{}).
...
">>,
            ...
            {error,[{{2,12},erl_lint,illegal_guard_expr},
                    {{4,12},erl_lint,illegal_guard_expr},
                    {{6,18},erl_lint,illegal_guard_expr},
                    {{8,12},erl_lint,illegal_guard_expr},
		    {{10,12},erl_lint,illegal_guard_expr},
		    {{12,18},erl_lint,illegal_guard_expr},
		    {{14,12},erl_lint,illegal_guard_expr},
		    {{16,12},erl_lint,illegal_guard_expr},
		    {{18,18},erl_lint,illegal_guard_expr},
		    {{20,12},erl_lint,illegal_guard_expr}],
	     [{{8,12},erl_lint,deprecated_tuple_fun},
	      {{14,12},erl_lint,deprecated_tuple_fun},
	      {{20,12},erl_lint,deprecated_tuple_fun},
	      {{28,12},erl_lint,deprecated_tuple_fun}]}},
           {guard6,
            <<"
...
">>,
            [],
            {errors,[{{7,19},erl_lint,{undefined_record,ful}}],
             []}},
           {guard7,
            <<"
-record(apa,{}).
...
">>,
           [],
           {errors,[{{3,18},erl_lint,{undefined_record,foo}},
                    {{4,25},erl_lint,{undefined_record,foo}},
                    {{5,27},erl_lint,{undefined_record,foo}}],
            []}}],
    ?line [] = run(Config, Ts),
    ok.
...
">>,
           [],
           {warnings,[{{3,15},erl_lint,{shadowed_var,'L','fun'}}]}},
          {otp_5091_6,
           <<"
t(A) ->
...
">>,
           [],
           {warnings,[{{2,21},erl_lint,{unused_var,'N'}}]}},
          {otp_5091_7,
           <<"
t() ->
    U = 8,
...
">>,
           [],
           {warnings,[{{3,12},erl_lint,{shadowed_var,'U','fun'}}]}},
          {otp_5091_8,
           <<"
t() ->
    [X || <<A:8,
...
">>,
           [],
           {warnings,[{{2,11},erl_lint,{unused_var,'A'}},
                      {{2,11},erl_lint,{shadowed_var,'A','fun'}},
                      {{3,11},erl_lint,{unused_var,'Q'}}]}},
          {otp_5091_13,
           <<"
...
">>,
           ...
           {warnings,[{{1,4},erl_lint,{unused_var,'A'}},
                      ...
                      {{2,11},erl_lint,{unused_var,'B'}},
                      {{2,9},erl_lint,{shadowed_var,'A','fun'}},
                      {{2,11},erl_lint,{shadowed_var,'B','fun'}},
                      {{3,9},erl_lint,{unused_var,'Q'}}]}},
          {otp_5091_14,
           <<"
t() ->
   A = 4,
...
">>,
           [],
           {warnings,[{{3,10},erl_lint,{unused_var,'A'}},
                      {{3,10},erl_lint,{shadowed_var,'A','fun'}}]}},
          {otp_5091_15,
           <<"
t() ->
    A = 4, % unused
...
">>,
           [],
           {warnings,[{{2,5},erl_lint,{unused_var,'A'}},
                      {{3,11},erl_lint,{shadowed_var,'A','fun'}}]}},
          {otp_5091_16,
           <<"
t() ->
    A = 4,
...
">>,
           [],
           {warnings,[{{4,11},erl_lint,{unused_var,'A'}},
                      {{4,11},erl_lint,{shadowed_var,'A','fun'}}]}},
          {otp_5091_17,
           <<"
t() ->
...
">>,
           [],
           {warnings,[{{3,11},erl_lint,{shadowed_var,'L','fun'}}]}},
          {otp_5091_18,
           <<"
t() ->
    L = 4,      % L unused
        ...
        {L,
         L}) ->
            a
             ...
             ">>,
           [],
           {warnings,[{{2,5},erl_lint,{unused_var,'L'}},
                      {{3,10},erl_lint,{shadowed_var,'L','fun'}}]}},
          {otp_5091_19,
           <<"
t() ->
    L = 4,
...
">>,
           [],
           {warnings,[{{3,13},erl_lint,{shadowed_var,'L',generate}}]}},
          {otp_5091_20,
           <<"
t() ->
    L = 4, % L unused.
...
">>,
           [],
           {warnings,[{{2,5},erl_lint,{unused_var,'L'}},
                      {{3,11},erl_lint,{unused_var,'L'}},
                      {{3,11},erl_lint,{shadowed_var,'L',generate}}]}},
          {otp_5091_21,
           <<"
t() ->
    L = 4,
...
">>,
           [],
           {warnings,[{{3,11},erl_lint,{unused_var,'L'}},
                      {{3,11},erl_lint,{shadowed_var,'L',generate}}]}},
          {otp_5091_22,
           <<"
t() ->
    ...
    fun(L) -> L end. % shadowed
           ...
           [],
           {warnings,[{{2,5},erl_lint,{unused_var,'L'}},
                      {{3,9},erl_lint,{shadowed_var,'L','fun'}}]}},
          {otp_5091_23,
           <<"t([A,A]) -> a.">>, [], []},
          {otp_5091_24,
           <<"t({A,A}) -> a.">>, [], []},
...
">>,
           ...
           {error,[{{1,2},erl_lint,{bad_deprecated,{frutt,0}}},
                   {{2,2},erl_lint,{bad_deprecated,{does_not_exist,1}}},
                   {{3,2},erl_lint,{invalid_deprecated,'foo bar'}},
                   {{5,2},erl_lint,{bad_deprecated,{f,'_'}}},
                   {{8,2},erl_lint,{invalid_deprecated,{'_','_',never}}},
                   {{9,2},erl_lint,{invalid_deprecated,{{badly,formed},1}}}],
            [{{12,1},erl_lint,{unused_function,{frutt,0}}}]}}],
    ?line [] = run(Config, Ts),
    ok.
...
t() ->
    f([]).
            ">>,
           [warn_obsolete_guard],
           {warnings,[{{5,11},erl_lint,{obsolete_guard,{list,1}}},
                      {{6,11},erl_lint,{obsolete_guard,{record,2}}},
                      {{7,11},erl_lint,{obsolete_guard,{pid,1}}}]}}],
    ?line [] = run(Config, Ts),
    ok.
...
t() ->
    qlc:q([X || X <- [],
            ...
            ">>,
           {[warn_unused_vars]},
           {warnings,[{{1002,1},erl_lint,{unused_function,{t,0}}},
                      {{1004,23},erl_lint,{unused_var,'A'}}]}},
...
unused_function(_, _) ->
    ok.
          ...
          {[warn_unused_vars, warn_unused_import]},
           {error,[{{5,2},erl_lint,{bad_inline,{inl,7}}},
                   {{6,2},erl_lint,{bad_inline,{inl,17}}},
                   {{11,5},erl_lint,{undefined_function,{fipp,0}}},
                   {{22,2},erl_lint,{bad_nowarn_unused_function,
                                     {and_not_used,2}}}],
            [{{3,2},erl_lint,{unused_import,{{b,1},'lists.foo'}}},
             {{9,1},erl_lint,{unused_function,{foop,0}}},
             {{19,1},erl_lint,{unused_function,{not_used,0}}},
             {{23,1},erl_lint,{unused_function,{and_not_used,1}}}]}},
...
">>,
           ...
           {errors2, [{{4,13},erl_parse,"bad record field"},
                      {{5,12},erl_parse,"bad record declaration"}],
                     [{{2,13},erl_lint,{redefine_field,a,x}},
                      {{14,6},erl_lint,{undefined_record,nix}},
                      {{15,10},erl_lint,{undefined_field,ok,nix}},
                      {{16,10},erl_lint,{field_name_is_variable,ok,'Var'}}]}},
...
">>,
           {[nowarn_unused_function, 
             ...
             warn_bif_clash]},
           {error,
            [{{5,5},erl_lint,{call_to_redefined_old_bif,{spawn,1}}}],
	    [{{4,11},erl_lint,{deprecated,{erlang,hash,2},{erlang,phash2,2},
			  "in a future release"}}]}},
...
">>,
           {[nowarn_unused_function]},
	   {errors,
            [{{2,2},erl_lint,disallowed_nowarn_bif_clash}],[]}},
...
spawn(A) ->
    ...
    spawn(A).
           ">>,
           {[nowarn_unused_function]},
           {error,[{{3,2},erl_lint,disallowed_nowarn_bif_clash},
		   {{4,2},erl_lint,disallowed_nowarn_bif_clash},
		   {{4,2},erl_lint,{bad_nowarn_bif_clash,{spawn,2}}}],
            [{{5,2},erl_lint,{bad_nowarn_deprecated_function,{3,hash,-1}}},
             {{5,2},erl_lint,{bad_nowarn_deprecated_function,{erlang,hash,-1}}},
             {{5,2},erl_lint,{bad_nowarn_deprecated_function,
                              {{a,b,c},hash,-1}}}]}
           },
...
">>,
           ...
           {warnings,
            [{{5,11},erl_lint,{deprecated,{erlang,hash,2},{erlang,phash2,2},
			  "in a future release"}}]}},
...
">>,
	   ...
	   {errors,[{{1,4},erl_lint,illegal_bin_pattern},
		    {{3,6},erl_lint,illegal_bin_pattern}],[]}},
	  {otp_5371_3,
           <<"
-record(foo, {a,b,c}).
-record(bar, {x,y,z}).
...
">>,
	   [],
	   {errors,[{{4,12},erl_lint,illegal_bin_pattern},
		    {{6,12},erl_lint,illegal_bin_pattern},
		    {{8,12},erl_lint,illegal_bin_pattern},
		    {{10,16},erl_lint,illegal_bin_pattern},
		    {{12,16},erl_lint,illegal_bin_pattern}],[]}},
	  {otp_5371_4,
           <<"
-record(foo, {a,b,c}).
-record(bar, {x,y,z}).
...
">>,
	   [],
	   {errors,[{{2,5},erl_lint,illegal_bin_pattern}],[]}},
	  {otp_7227_5,
           <<"
t(Val) ->
    <<A:8>> = X = <<B:8>> = Val,
...
">>,
	   [],
	   {errors,[{{2,22},erl_lint,illegal_bin_pattern},
		    {{2,22},erl_lint,illegal_bin_pattern},
		    {{2,32},erl_lint,illegal_bin_pattern}],[]}},
	  {otp_7227_8,
           <<"
t(Val) ->
    (<<A:8>> = X) = (Y = <<B:8>>) = Val,
...
">>,
	   [],
	   {errors,[{{2,26},erl_lint,illegal_bin_pattern}],[]}},
	  {otp_7227_9,
           <<"
t(Val) ->
    (Z = <<A:8>> = X) = (Y = <<B:8>> = W) = Val,
...
">>,
	   [],
	   {errors,[{{2,30},erl_lint,illegal_bin_pattern}],[]}}
	 ],
    ?line [] = run(Config, Ts),
    ok.
...
">>,
           [],
           {warnings,[{{2,2},erl_lint,{duplicated_export,{t,0}}}]}}],
    ?line [] = run(Config, Ts),
    ok.
...
">>,
           ...
           {error,[{{1,20},erl_lint,{undefined_record,rec2}}],
                  [{{2,2},erl_lint,{unused_record,rec2}}]}},
...
">>,
           ...
           {error,[{{1,34},erl_lint,{unbound_var,'B'}},
                   ...
                   {{2,24},erl_lint,{variable_in_record_def,'A'}}],
...
">>,
           [warn_unused_record],
           {errors,[{{2,30},erl_lint,{variable_in_record_def,'A'}},
                    {{3,30},erl_lint,{variable_in_record_def,'A'}}],
            []}},
...
">>,
           ...
           {error,[{{1,19},erl_lint,{unbound_var,'A'}},
                   {{2,19},erl_lint,{unbound_var,'A'}},
                   {{4,28},erl_lint,{variable_in_record_def,'A'}},
                   {{17,30},erl_lint,{variable_in_record_def,'A'}}],
            [{{8,22},erl_lint,{unused_var,'X'}}]}},
...
">>,
           [warn_unused_record],
           {errors,[{{3,26},erl_lint,{unbound_var,'Y'}},
                    {{4,24},erl_lint,{variable_in_record_def,'Y'}}],
            []}},
...
">>,
           [warn_unused_record],
           {error,[{{3,17},erl_lint,{unbound_var,'A'}},
                   {{3,24},erl_lint,{unbound_var,'THIS'}}],
            [{{10,12},erl_lint,{unused_var,'THIS'}},
             {{10,12},erl_lint,{shadowed_var,'THIS','fun'}}]}},
...
">>,
           [warn_unused_record],
           {error,[{{6,41},qlc,{used_generator_variable,'A'}},
                   {{6,43},qlc,{used_generator_variable,'Y'}},
                   {{6,35},qlc,{used_generator_variable,'Z'}}],
            [{{4,46},erl_lint,{unused_var,'V'}}]}},
...
">>,
           [warn_unused_record],
           {errors,[{{4,18},erl_lint,{unbound_var,'A'}},
                    {{11,17},erl_lint,illegal_guard_expr},
                    {{13,21},erl_lint,{undefined_field,r3,q}},
                    {{15,20},erl_lint,{undefined_field,r,q}},
                    {{19,27},erl_lint,illegal_guard_expr},
                    {{21,16},erl_lint,{illegal_guard_local_call,{l,0}}}],
            []}},
...
">>,
           [warn_unused_record],
           {errors,[{{2,10},erl_lint,{undefined_function,{x,0}}},
                    {{3,16},erl_lint,illegal_guard_expr},
                    {{5,16},erl_lint,illegal_guard_expr}],
            []}},
...
">>,
           [warn_unused_record],
           {warnings,[{{3,2},erl_lint,{unused_record,u3}},
                      {{4,2},erl_lint,{unused_record,u4}}]}},
...
">>,
           [warn_unused_record],
           {warnings,[{{4,13},erl_lint,{missing_qlc_hrl,1}},
                      {{5,13},erl_lint,{missing_qlc_hrl,2}},
                      {{6,10},erl_lint,{missing_qlc_hrl,2}}]}}
         ],
    ?line [] = run(Config, Ts),
...
">>,
           ...
           {errors,[{{1,14},erl_lint,unsized_binary_not_at_end},
		                {{2,14},erl_lint,unsized_binary_not_at_end},
		                {{3,14},erl_lint,unsized_binary_not_at_end},
		                {{8,7},erl_lint,typed_literal_string},
		                {{10,7},erl_lint,typed_literal_string},
		                {{12,7},erl_lint,typed_literal_string},
		                {{14,7},erl_lint,typed_literal_string}],
                   []}}
         ],
	  ?line [] = run(Config, Ts),
    ok.
...
">>,
           {[warn_export_all]},
           {warnings,[{{2,2},erl_lint,export_all}]}}
         ],
    ?line [] = run(Config, Ts),
    ok.
...
">>,
           [],
	   {errors,[{{2,5},erl_lint,{call_to_redefined_old_bif,{size,1}}}],[]}},
...
">>,
	   [],
	   {errors,[{{5,5},erl_lint,{call_to_redefined_old_bif,{size,1}}}],[]}},
...
">>,
	   [],
	   {warnings,[{{3,5},erl_lint,{call_to_redefined_bif,{binary_part,2}}}]}},
...
">>,
	   [],
	   {errors,[{{3,11},erl_lint,{illegal_guard_local_call,{binary_part,2}}}],[]}},
...
">>,
	   [],
	   {errors,[{{4,5},erl_lint,{undefined_function,{binary_part,2}}}],[]}},
...
">>,
	   [],
	   {errors,[{{5,30},erl_lint,{undefined_function,{binary_part,2}}}],[]}},
...
">>,
	   [],
	   {errors,[{{2,2},erl_lint,{redefine_old_bif_import,{abs,1}}}],[]}},
...
">>,
	   [],
	   {warnings,[{{2,2},erl_lint,{redefine_bif_import,{binary_part,3}}}]}},
...
">>,
	   [],
	   {errors,[{{3,2},erl_lint,{redefine_import,{{binary_port,3},x}}}],[]}},
...
">>,
	   [],
	   {errors,[{{3,1},erl_lint,{define_import,{binary_port,3}}}],[]}},
...
">>,
	   [],
	   {errors,[{{4,26},erl_lint,illegal_guard_expr}],[]}},
	  %% Not with local functions either
	  {clash20,
           <<"
-export([binary_port/3]).
...
">>,
	   ...
	   {errors,[{{4,11},erl_lint,{illegal_guard_local_call,{is_tuple,1}}},
		    {{5,11},erl_lint,{illegal_guard_local_call,{is_list,1}}},
		    {{6,11},erl_lint,{illegal_guard_local_call,{is_tuple,1}}},
		    {{7,11},erl_lint,{illegal_guard_local_call,{is_list,1}}},
		    {{8,11},erl_lint,{illegal_guard_local_call,{is_record,3}}},
		    {{9,11},erl_lint,{illegal_guard_local_call,{is_record,3}}}],
            []}}
	 ],
...
">>,
	   ...
	   {warnings,[{{1,2},erl_lint,{undefined_behaviour_func,{start,2},
		      ...
		      {{2,2},erl_lint,{undefined_behaviour_func,{init,1},
                       supervisor}}]}},
...
">>,
           [],
           {errors,[{{2,7},erl_lint,utf_bittype_size_or_unit},
		    {{4,7},erl_lint,utf_bittype_size_or_unit},
		    {{6,7},erl_lint,utf_bittype_size_or_unit},
		    {{9,7},erl_lint,utf_bittype_size_or_unit},
		    {{11,7},erl_lint,utf_bittype_size_or_unit},
		    {{13,7},erl_lint,utf_bittype_size_or_unit},
		    {{16,7},erl_lint,utf_bittype_size_or_unit},
		    {{18,7},erl_lint,utf_bittype_size_or_unit},
		    {{20,7},erl_lint,utf_bittype_size_or_unit}
		   ],
            []}}],
    ?line [] = run(Config, Ts),
    ok.
...
">>,
	   {[]},				%Tuple indicates no 'export_all'.
	   {errors,
	    [{{2,2},erl_lint,multiple_on_loads}],[]}},
...
run_test(Conf, <<"\n-module", Rest/binary>>, Warnings0) ->
    Test = <<"-module", Rest/binary>>,
